...
require_once('includes/releasedHiddenInvClass.php');

//http://sunnyshende.jdsoftware.com/jdbox/services/invMgmt.php?parentid=P1&version=12&astatus=1&astate=1&trace=1



//$url="http://vishalvinodrana.jdsoftware.com/jdbox/services/releasedHiddenInv.php";
...
if(empty($params['data_city']) || empty($params['parentid']) || empty($params['astatus']) || empty($params['astate']))
{
...
{
	$invmgmtclassobj = new invMgmtHiddenClass($params);

	$result = $invmgmtclassobj->manageDeleteInventory();
