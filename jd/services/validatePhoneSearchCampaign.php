...
require_once('includes/validate_phonsearch_campaign_class.php');
...
$validate_phonsearch_campaign_obj = new validate_phonsearch_campaign_class($params);


if($params['action']=='validatePincode')
{
//echo json_encode($params);
//exit;
$result = $validate_phonsearch_campaign_obj->validatePincode();	
