...
class Virtualnumber
{
	...
	function genio_update_virtual_number($parentid,$verticalFlag='',$expired_display_flag='')
    {
		...
		if($this->JDFOS_flag == true)
		{
			...
			$extra_str="[virtual number :".intval($this->virtualno)."] [VN eligible Vertical flag : ".$verticalFlag."]";
        ...
        if($this->paid_flag ==1 || $verticalFlag ==1 || $this->JDFOS_flag)
        { 
			$this->vnEligibleCompaign = $this->checkVnEligibleCampaign();
			//if($this->vnEligibleCompaign || $jdfocFlag ==1)
			if($this->vnEligibleCompaign || $verticalFlag ==1)
			{
	...
	function genio_block_for_vn_category($parentid)
	{
		...
		if(($this->paid_flag ==1 || $verticalFlag ==1 || $this->JDFOS_flag) && (intval($this->virtualno)<=0))
		{
	...
	function getSingleMappednumber($pid)
	{
		...
		$temparr	= array();
		$fieldstr	= "stdcode, landline_display, mobile_display, tollfree, landline, mobile,virtualNumber,companyname,mobile_feedback,email_feedback,pincode,area";
		$where 		= "parentid='".$pid."'";
	...
	function checkJdfos()
	{
		...
		else
		{
			...
			if($jdfos_json['results']['gen_info']['0']['parentid'] == $this->parentid && $jdfos_json['results']['gen_info']['0']['isDelivers']==1)
			{
			...
			else if($jdfos_json['results']['gen_info']['0']['parentid'] == $this->parentid)
			{
