<?php
/* TECH WEB API DB IP*/
define("MUMBAI_TECH_DB_IP", "172.29.66.208");
define("DELHI_TECH_DB_IP", "210.211.164.229");
define("DELHI_STANDBY_TECH_DB_IP", "122.176.103.145");
define("KOLKATA_TECH_DB_IP", "172.29.16.208");
define("BANGALORE_TECH_DB_IP", "172.29.26.208");
define("CHENNAI_TECH_DB_IP", "172.29.32.208");
define("PUNE_TECH_DB_IP", "172.29.40.208");
define("HYDERABAD_TECH_DB_IP", "172.29.50.208");
define("AHMEDABAD_TECH_DB_IP", "172.29.56.208");

define("TECH_INFO_DB_USERID", "root");
define("TECH_INFO_DB_PASSWORD", "1234");
define("TECH_INFO_DB_NAME", "vconnect");
define("TECH_INFO_DB_TBLNAME", "vrnmap_sync");
define("TECH_INFO_DB_UPDATE", false);

/* TECH WEB API URL */
define("MUMBAI_TECH_API_URL", "172.29.66.208:81");
define("DELHI_TECH_API_URL", "210.211.164.229:81");
//define("DELHI_TECH_API_URL", "122.176.103.145:81");
//define("DELHI_STANDBY_TECH_DB_IP", "122.176.103.145:81");
define("KOLKATA_TECH_API_URL", "172.29.16.208:81");
define("BANGALORE_TECH_API_URL", "172.29.26.208:81");
define("CHENNAI_TECH_API_URL", "172.29.32.208:81");
define("PUNE_TECH_API_URL", "172.29.40.208:81");
define("HYDERABAD_TECH_API_URL", "172.29.50.208:81");
define("AHMEDABAD_TECH_API_URL", "172.29.56.208:81");
define("CHANDIGARH_MAP_DETAILS_DB_IP", "172.29.74.172");
define("JAIPUR_MAP_DETAILS_DB_IP", "172.29.101.172");
define("COIMBATORE_MAP_DETAILS_DB_IP", "172.29.72.56");
define("CHANDIGARH_MAP_DETAILS_DB_IP_PROCESS", "192.168.17.171");
define("JAIPUR_MAP_DETAILS_DB_IP_PROCESS", "192.168.17.171");
define("COIMBATORE_MAP_DETAILS_DB_IP_PROCESS", "192.168.17.171");

/* RELIANCE WEB API URL */


define("AHMEDABAD_RELIANCE_API_URL", "172.16.1.1:8100");
if(APP_LIVE == 0)
{
	define("COIMBATORE_RELIANCE_API_URL", "172.16.1.13:8100");
}
else
{
	define("COIMBATORE_RELIANCE_API_URL", "imteyazraja.jdsoftware.com/csgenio");
}
...
'DELHI' => array
    (
        ...
        array('MIN'=>61607080 , 'MAX'=>61607080),
...
{	
    global $conn_iro,$conn_decs; //$techinfo_pri_series
    ...
    if(intval($landline)>0)
	{
		...
		$tbl_virtual_number_range_query = $conn_decs->query_sql($select_tbl_virtual_number_range);
		$tbl_virtual_number_range_data  = $conn_decs->numRows($tbl_virtual_number_range_query);
